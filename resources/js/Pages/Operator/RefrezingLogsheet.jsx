                ...
                <div className="max-w-[1500px] mx-auto px-4 py-6">
                    ...
                    <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200 mb-6 flex items-center justify-between gap-4 flex-wrap">
                        <div className="flex items-center gap-6 flex-wrap">
                            <h1 className="text-xl font-black text-slate-800 uppercase tracking-widest">LOGSHEET REFREZING</h1>
                            ...
                            <div className="flex items-center gap-1.5">
                                ...
                                {uniqueShifts.map(s => (
                                    <PillTab key={s} active={filterShift === s.toString()} onClick={() => setFilterShift(s.toString())} label={`Shift ${s}`} colorClass="bg-blue-600 text-white" />
                                ))}
                            </div>
                        </div>
                        <Link href="/refrezing-kiosk" className="px-5 py-2 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-bold text-[10px] uppercase tracking-widest rounded-full transition-all shadow-sm">
                            ← Ke Terminal
                        </Link>
                    </div>
                                ...
                                <div key={idx} className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                                    ...
                                    <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
                                        <div className="flex items-center gap-3 text-xs font-bold text-slate-600">
                                            ...
                                            <span className="text-sm font-black text-slate-800">Refrezing</span>
                                            <span className="text-slate-300">|</span>
