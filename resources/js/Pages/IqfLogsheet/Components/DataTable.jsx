                            ...
                            <div className="print-header hidden flex-col border-b-2 border-slate-300 pb-3 mb-0 px-5 pt-4">
                                ...
                                <div className="grid grid-cols-[auto_1fr_auto] items-center gap-4 mb-3">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="font-bold text-sm tracking-wider uppercase m-0">INPUT IQF DAN FREEZING</p>
                                    </div>
                                ...
                                <div className="print-info hidden grid grid-cols-4 gap-4 text-xs border border-slate-300 bg-slate-50 p-2.5 rounded-lg">
                                    ...
                                    <div><span className="font-semibold text-slate-500">IQF:</span> <span className="font-bold">{group.machine}</span></div>
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-3.5 py-2.5 text-xs">
                                                        {row.unplanned_stop !== '-' ? (
                                                            <span className="inline-flex items-center gap-1 px-3 py-1 rounded-lg text-xs font-medium bg-[#ffe4e6] text-[#e11d48] border border-[#fecdd3]">
                                                                {row.unplanned_stop}
                                                            </span>
                                                        ) : <span className="text-slate-300 text-xs">-</span>}
                                                    </td>
                ...
                const renderPrintPage = (pageIdx, sList, p1List, p2List, lList, aList, stList) => (
                    <div key={pageIdx} className="spt-page">
                        ...
                        <div className="spt-info-row">
                            ...
                            <div className="spt-info-col"><b>IQF</b>: {pg.machine}</div>
