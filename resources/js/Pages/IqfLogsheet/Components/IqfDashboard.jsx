...
export default function IqfDashboard() {
    ...
    return (
        <div className="space-y-6 select-none max-w-[1400px] mx-auto pb-12">
            ...
            {/* ── HEADER BANNER ─────────────────────────────────────────────── */}
            <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white rounded-3xl p-5 sm:p-6 md:p-8 shadow-2xl border border-slate-800">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 via-indigo-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-500/30 border border-white/20 shrink-0">
                        ...
                        <div>
                            ...
                            <p className="text-slate-400 text-xs sm:text-sm font-medium mt-0.5 flex items-center gap-1.5">
                                ...
                                Waktu WIB: <span className="text-indigo-200 font-bold"><LiveClock /></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 w-full lg:w-auto justify-start lg:justify-end">
                        ...
                        <div className="flex items-center justify-between sm:justify-start gap-2 bg-slate-800/80 rounded-2xl px-3.5 py-2 border border-white/10 backdrop-blur-md w-full sm:w-auto">
                            ...
                            <span className="text-indigo-400 font-black text-xs sm:text-sm">→</span>
                            <select
                                value={toTime}
                        ...
                        <button
                            ...
                            className="h-10 px-4 sm:w-10 sm:px-0 flex items-center justify-center rounded-2xl bg-slate-800/80 hover:bg-indigo-600/80 border border-white/10 text-slate-200 hover:text-white transition-all cursor-pointer shadow-sm"
                        >
