            ...
            <div className="bg-[#1a2035] text-white border border-slate-800 shadow-xl rounded-3xl p-4 sm:p-5 md:px-8">
                <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4 sm:gap-6">
                    <div className="flex items-center gap-3 sm:gap-4 w-full lg:w-auto">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-500/25 shrink-0">
                            <Activity className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
                        </div>
                        <div>
                            <h2 className="text-white text-lg sm:text-xl font-black tracking-tight m-0">Dashboard Produksi IQF</h2>
                            <div className="flex items-center gap-2 mt-1">
                                <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                                <span className="text-indigo-200 text-xs sm:text-sm font-semibold flex items-center gap-1.5">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2.5 w-full lg:w-auto justify-start lg:justify-end">
                        ...
                        <div className="flex items-center justify-between sm:justify-start gap-2 bg-[#272f48] rounded-xl px-3 py-2 border border-white/10 w-full sm:w-auto">
                            ...
                            <span className="text-indigo-300 font-bold text-xs sm:text-sm">→</span>
                            <select
                                value={toTime}
                        ...
                        <button
                            ...
                            disabled={loading}
                            title="Refresh Data"
                            className="h-10 px-4 sm:px-0 sm:w-10 flex items-center justify-center rounded-xl bg-[#272f48] hover:bg-[#323b56] border border-white/10 text-indigo-200 hover:text-white transition-all cursor-pointer"
                        >
                            ...
                            return (
                                <div key={mName} className="bg-slate-50/70 border border-slate-200/80 rounded-2xl p-5 flex flex-col justify-between space-y-3 h-full">
                                    <div className="flex items-center justify-between">
                                        <span className="text-xs font-black uppercase tracking-widest bg-indigo-100 text-indigo-800 border border-indigo-300 px-3.5 py-1.5 rounded-full inline-block shadow-2xs">
                                            {mName}
                                        </span>
                                    </div>
                                ...
                                {stats.unplanned_stops.map((stop, idx) => {
                                    ...
                                    return (
                                        <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td className="px-5 py-3.5">
                                                <span className="text-[11px] font-black uppercase tracking-wider bg-indigo-50 text-indigo-700 border border-indigo-200 px-2.5 py-1 rounded-full inline-block">
                                                    {stop.machine}
                                                </span>
                                            </td>
                                            <td className="px-5 py-3.5">
