...
const getCurrentShiftAndDate = () => {
    const now = new Date();
    // Format tanggal WIB secara langsung — hindari toISOString() yg selalu UTC
...
export default function Kiosk({ latestEntries }) {
    ...
    const formatLatestText = (m) => {
        ...
        const isPack = entry.product_type === 'lumpia' || entry.product_type === 'adonan_pangsit';
                    ...
                    <div className="w-full max-w-4xl mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="text-center mb-10">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                                {/* IQF 1 */}
                                <div className="inline-flex items-center gap-2 bg-white/95 backdrop-blur-md px-5 py-2 rounded-full border-2 border-blue-400 shadow-md">
                                    <span className="w-2.5 h-2.5 rounded-full bg-blue-500 animate-pulse"></span>
                                    <span className="text-xs md:text-sm font-black text-slate-700 uppercase tracking-[0.1em]">IQF 1:</span>
                                    <span className="text-xs md:text-sm font-black text-blue-600 uppercase tracking-[0.1em] bg-blue-50 px-3 py-0.5 rounded-full border border-blue-200">
