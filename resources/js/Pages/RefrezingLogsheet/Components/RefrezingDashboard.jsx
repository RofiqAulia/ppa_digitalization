            ...
            <CCard className="bg-[#1a2035] text-white border-0 shadow-lg rounded-3xl p-4 sm:p-5 md:px-8">
                <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4 sm:gap-6">
                    <div className="flex items-center gap-3 sm:gap-4 w-full lg:w-auto">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center shadow-lg shadow-cyan-500/20 shrink-0">
                            <Activity className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
                        </div>
                        <div>
                            <h2 className="text-white text-lg sm:text-xl font-bold tracking-tight m-0">Dashboard Produksi Refrezing</h2>
                ...
                <CCardBody className="p-6 md:p-8">
                    <CRow className="g-4">
                        {machineNames.map(mName => {
                            ...
                            return (
                                <CCol key={mName} md={machineNames.length > 2 ? 4 : 6}>
                                    <div className="bg-slate-50/70 border border-slate-200/80 rounded-2xl p-5 flex flex-col justify-between space-y-3 h-full">
                                        <div className="flex items-center justify-between">
                                            <CBadge color="info" className="text-xs font-black uppercase tracking-widest bg-cyan-50 text-cyan-700 border border-cyan-200 px-3 py-1 rounded-full">
                                                {mName}
                                            </CBadge>
                                        </div>
                                ...
                                {stats.unplanned_stops.map((stop, idx) => {
                                    ...
                                    return (
                                        <CTableRow key={idx}>
                                            ...
                                            <CTableDataCell className="px-5 py-3.5">
                                                <CBadge color="info" className="text-[11px] font-black uppercase tracking-wider bg-cyan-50 text-cyan-600 border border-cyan-200 px-2.5 py-1 rounded-full">
                                                    {stop.machine}
                                                </CBadge>
                                            </CTableDataCell>
                                            <CTableDataCell className="px-5 py-3.5">
