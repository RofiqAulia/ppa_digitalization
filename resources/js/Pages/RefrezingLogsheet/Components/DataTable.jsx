...
export default function DataTable({ logsheets }) {
    ...
    const submitEdit = () => {
        setIsSaving(true);
        router.put(`/refrezing-logsheet-detail/${editData.id}`, editData, {
            preserveScroll: true,
    ...
    const confirmDelete = () => {
        ...
        setIsSaving(true);
        router.delete(`/refrezing-logsheet-detail/${deleteConfirmId}`, {
            preserveScroll: true,
            onSuccess: () => {
                setIsSaving(false);
                ...
                <div className="flex flex-wrap items-center gap-2 px-3 py-3 border-b border-slate-100 lg:px-4">
                    ...
                    <Select value={filterMachine} onValueChange={v => { setFilterMachine(v); setCurrentPage(1); }}>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="Refrezing 1">Refrezing 1</SelectItem>
                            <SelectItem value="Refrezing 2">Refrezing 2</SelectItem>
                            <SelectItem value="Refrezing 3">Refrezing 3</SelectItem>
                        </SelectContent>
                    </Select>
                        ...
                        <div key={group.key} className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden print-group">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className={`w-2.5 h-2.5 rounded-full ${group.machine === 'Refrezing 1' ? 'bg-indigo-500' : 'bg-purple-500'} shadow`} />
