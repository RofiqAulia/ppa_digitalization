...
<div class="w-full h-[calc(100vh-82px)] flex flex-col font-sans text-slate-800 overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 p-3 sm:p-5">
    ...
    <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/40 border border-slate-200/60 flex-1 flex flex-col w-full p-4 sm:p-6 overflow-hidden relative">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-4 shrink-0">
            <div>
                <h1 class="text-xl font-extrabold text-slate-900 tracking-tight">Riwayat Formulir IQF & Freezing</h1>
                <p class="text-xs text-slate-400 font-medium mt-0.5">List of historical production logsheet records</p>
            </div>
            ...
            <div class="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end">
                ...
                <!-- Action Buttons -->
                <a href="{{ route('iqf-logsheet.index') }}" style="background-color: #3b82f6; color: white;" class="inline-flex items-center gap-2 px-4 py-1.5 rounded-xl text-xs font-bold shadow-sm transition-all duration-150 transform hover:-translate-y-0.5 active:scale-95" onmouseover="this.style.backgroundColor='#2563eb'" onmouseout="this.style.backgroundColor='#3b82f6'">
                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
